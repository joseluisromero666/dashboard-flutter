...
List<Account> accountList = [
  Account(
      title: "Log Out",
      accountImageWidget: getImage(
          "https://firebasestorage.googleapis.com/v0/b/fukl-48022-g51-2021-2-team3.appspot.com/o/back.png?alt=media&token=7367197b-9120-4eab-a9de-f63d357f7bf2"))
];

getImage(String assetPath) {
...
class _NavbarState extends State<Navbar> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool tagsExist = widget.tags == null ? false : (widget.tags.length == 0 ? false : true);

    return SingleChildScrollView(
        child: Container(
            height: widget.searchBar
                ? (!categories ? (tagsExist ? 211.0 : 178.0) : (tagsExist ? 262.0 : 210.0))
                : (!categories ? (tagsExist ? 162.0 : 92.0) : (tagsExist ? 200.0 : 150.0)),
            decoration: BoxDecoration(color: !widget.transparent ? widget.bgColor : Colors.transparent, boxShadow: [
              BoxShadow(
                  color: !widget.transparent && !widget.noShadow ? ArgonColors.initial : Colors.transparent,
                  spreadRadius: -10,
                  blurRadius: 12,
                  offset: Offset(0, 5))
            ]),
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.camera, color: ArgonColors.initial, size: 22.0),
                                SizedBox(width: 10),
                                Text(widget.categoryOne, style: TextStyle(color: ArgonColors.initial, fontSize: 16.0)),
                              ],
                            ),
                          ),
                          SizedBox(width: 30),
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.shopping_cart, color: ArgonColors.initial, size: 22.0),
                                SizedBox(width: 10),
                                Text(widget.categoryTwo, style: TextStyle(color: ArgonColors.initial, fontSize: 16.0)),
                              ],
                            ),
                          )
                        ],
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color:
                                          activeTag == widget.tags[index] ? ArgonColors.primary : ArgonColors.secondary,
                                      borderRadius: BorderRadius.all(Radius.circular(4.0))),
                                  child: Center(
                                    child: Text(widget.tags[index],
                                        style: TextStyle(
                                            color:
                                                activeTag == widget.tags[index] ? ArgonColors.white : ArgonColors.black,
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14.0)),
                                  )),
                            );
