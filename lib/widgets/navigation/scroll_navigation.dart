...
class ScrollNavigationState extends State<ScrollNavigation> {
  ...
  void initState() {
    ...
    _verticalPosition = _barStyle.position == NavigationPosition.left || _barStyle.position == NavigationPosition.right;
    ...
    Misc.onLayoutRendered(() => setState(() => _navSize =
        _barStyle.position == NavigationPosition.left || _barStyle.position == NavigationPosition.right
            ? _navKey.width ?? 0.0
            : _navKey.height ?? 0.0));
    super.initState();
  }
  ...
  void _scrollListener() {
    ...
    if (widget.physics) {
      ...
      if (currentPage + 1 < widget.pages.length) _setItemLerp(currentPage + 1, (page - currentPage));
      _setItemLerp(currentPage, 1 - (page - currentPage));
      if (widget.showIdentifier) _identifierPosition.value = _identifierLength * page;
    }
  }
  ...
  void _onPageChanged(index) {
    setState(() {
      if (!widget.physics) {
        ...
        if (widget.showIdentifier) _identifierPosition.value = _identifierLength * index;
      }
      ...
      child: OrientationBuilder(
        builder: (_, Orientation orientation) {
          if (_orientation == null || _orientation != orientation) {
            final double size =
                (_verticalPosition ? context.media.height : context.media.width) * (1 / widget.items.length);
          ...
          return Scaffold(
            body: Column(children: [
              ...
              Expanded(
                child: Row(children: [
                  if (_barStyle.position == NavigationPosition.left) _buildNavigation(_barStyle.elevation),
                  Expanded(
                    child: ClipRRect(
                  ...
                  if (_barStyle.position == NavigationPosition.right) _buildNavigation(1 - _barStyle.elevation),
                ]),
              ),
            ]),
            bottomNavigationBar:
                _barStyle.position == NavigationPosition.bottom ? _buildNavigation(1 - _barStyle.elevation) : null,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              spreadRadius: -3,
              blurRadius: 2,
              offset: _verticalPosition ? Offset(elevation, 0.0) : Offset(0.0, elevation),
            ),
          ],
        ),
        ...
        child: AnimatedBuilder(
          ...
          builder: (_, __) => _verticalPosition
              ? Column(mainAxisAlignment: MainAxisAlignment.center, children: _buildNavigationIcons())
        ...
        ValueListenableBuilder<double>(
          ...
          builder: (_, double value, ___) => _verticalPosition
              ? Positioned(
                  ...
                  left: _identifierStyle.position == IdentifierPosition.bottomAndLeft
                      ? 0
              ...
              : Positioned(
                  ...
                  bottom: _identifierStyle.position == IdentifierPosition.bottomAndLeft ? 0 : null,
                  child: _identifer(),
                ),
        ),
    ]);
