...
class _TitleScrollNavigationState extends State<TitleScrollNavigation> {
  ...
  void _setTitlesWidth() {
    setState(() {
      for (int i = 0; i < _titlesProps.length; i++) _titlesProps[i].width = _titlesProps[i].key.width ?? 0;
          ...
          Padding(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              for (int i = 0; i < _titlesProps.length; i++) ...[
                ...
                if (i != _titlesProps.length - 1) SizedBox(width: widget.barStyle.spaceBetween),
              ]
            ]),
          ),
