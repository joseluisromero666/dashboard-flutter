        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          Expanded(
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Container(
                  height: 65,
                  child: ClipRRect(borderRadius: BorderRadius.circular(4.0), child: Image.network(img)),
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Text(body, style: TextStyle(color: ArgonColors.black, fontSize: 13, fontWeight: FontWeight.w400)),
                    Expanded(
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(stock == true ? 'In Stock' : 'Not In Stock',
                                style: TextStyle(
                                    color: stock == true ? ArgonColors.success : ArgonColors.error,
                                    fontSize: 12,
                          ...
                          Padding(
                            ...
                            child: Text("\$$price",
                                style:
                                    TextStyle(color: ArgonColors.primary, fontSize: 11, fontWeight: FontWeight.w500)),
                          ),
                        ],
                      ),
                    ),
          ...
          child: DropdownButton<String>(
            ...
            items: <String>['1', '2', '3', '4'].map<DropdownMenuItem<String>>((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value,
                    style: TextStyle(color: ArgonColors.white, fontWeight: FontWeight.w600, fontSize: 12.0)),
              );
            }).toList(),
          ),
        ),
