    ...
    return Scaffold(
      ...
      Container(
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/img/pro-background.png"), fit: BoxFit.cover))),
      Padding(
          ...
          child: SafeArea(
            child: Column(
              ...
              children: <Widget>[
                          ...
                          children: <InlineSpan>[
                            WidgetSpan(
                                child: Container(
                                    ...
                                    margin: EdgeInsets.fromLTRB(0.0, 0.0, 50.0, 50.0),
                                    decoration: BoxDecoration(
                ...
                Text("Take advantage of all the features and screens made by Creative-Tim, coded on Flutter for both",
                  ...
                  child: SizedBox(
                    ...
                    child: FlatButton(
                      ...
                      child: Padding(
                          ...
                          child: Text("BUY NOW", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0))),
                    ),
                  ),
                )
              ],
