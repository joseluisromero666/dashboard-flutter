    ...
    return Scaffold(
      ...
      Container(
          decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/img/onboard-background.png"), fit: BoxFit.cover))),
      Padding(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text.rich(TextSpan(
                        text: "Design System",
                        style: TextStyle(color: Colors.white, fontSize: 58, fontWeight: FontWeight.w600),
                      )),
                    ),
                    Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: FlatButton(
                      ...
                      child: Padding(
                          ...
                          child: Text("GET STARTED", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0))),
                    ),
                  ),
                )
              ],
